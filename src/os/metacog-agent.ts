...
export class OsMetacognitiveAgent {
  ...
  buildSystemPrompt(): string {
    return [
      ...
      "  task(name, objective)     — a unit of work (an LLM process)",
      ...
      "",
      "  Task options: model (string), priority (0-100), backend (see below)",
      "  Backends:",
      ...
      "- Observation density should match composition complexity. High-composition topologies need",
      "  observers at boundaries.",
      "",
      "## Goal",
      "",
      `${this.goal}`,
