...
export class LlmExecutorBackend implements ExecutorBackend, ExecutorContextInjectable, ExecutorStreamable, ExecutorCheckpointable {
  ...
  private buildArchitectPhasePrompt(proc: OsProcess): string {
    ...
    lines.push(
      ...
      "{ kind: 'bb_write', key: 'selected_blueprint', value: { ... } },",
      "{ kind: 'spawn_graph', nodes: [",
      "  { name: 'phase0-worker', type: 'lifecycle', objective: '...', priority: 40, after: [] },",
      "  { name: 'phase0-observer', type: 'lifecycle', objective: '...', priority: 38, after: ['phase0-worker'] }",
      "] },",
      "{ kind: 'idle', wakeOnSignals: ['child:done'] }",
      "```",
      "",
      ...
      "```",
      "{ kind: 'spawn_graph', nodes: [",
      "  { name: 'scaffold-builder', type: 'lifecycle', objective: '...', priority: 40, after: [] },",
      "  { name: 'scaffold-observer', type: 'lifecycle', objective: '...', priority: 38, after: ['scaffold-builder'] }",
      "] }",
      "```",
