...
const EXTRACTORS = new Map<string, (event: ProtocolEvent) => LensCognitiveEvent | null>();
 ...
 */
export function extractCognitiveEvent(event: ProtocolEvent): LensCognitiveEvent | null {
